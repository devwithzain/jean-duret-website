      ...
      <div class="w-full grid grid-cols-3 gap-10">
         <div class="w-full h-[400px] shadow-[0_0_15px_rgba(0,0,0,0.15)] bg-[#000D51] p-10">
            <div class="w-full h-full flex flex-col justify-center gap-5">
               <img src={{ asset('assets/loan.svg') }} alt="heroGirl" class="w-20 h-20 object-cover">
               ...
               <button
                  class="w-fit text-white text-xl font-medium leading-tight tracking-tight px-10 py-3 bg-[#2460FD]">Details</button>
            </div>
         </div>
         <div class="w-full h-[400px] shadow-[0_0_15px_rgba(0,0,0,0.15)] hover:bg-[#000D51] bg-white p-10 group">
            <div class="w-full h-full flex flex-col justify-center gap-5">
               <img src={{ asset('assets/home.svg') }} alt="heroGirl" class="w-20 h-20 object-cover">
         ...
         <div class="w-full h-[400px] shadow-[0_0_15px_rgba(0,0,0,0.15)] hover:bg-[#000D51] bg-white p-10 group">
            <div class="w-full h-full flex flex-col justify-center gap-5">
               <img src={{ asset('assets/hands.svg') }} alt="heroGirl" class="w-20 h-20 object-cover">
               <h1 class="group-hover:text-white text-[#000D51] text-3xl font-semibold leading-tight tracking-tight">
