    ...
    <div>
        <div class=" w-full flex items-center justify-between gap-4 border-b border-black/15 pb-3">
            <div class="flex flex-col">
                ...
                <p class="paragraph font-normal ">Manage Services for
                    your website.</p>
            </div>
            <a href={{ route('create') }}
                class="paragraph text-white dark:text-black bg-black dark:bg-white font-normal  flex items-center gap-2 px-4 py-2 rounded-lg">
        ...
        <div class="w-full py-8">
            <input
                class="w-[400px] bg-white dark:bg-black px-5 py-1 paragraph  rounded-lg border border-black/10 dark:border-gray-700 shadow-[0_0_1px_rgba(0,0,0,0.2)]"
