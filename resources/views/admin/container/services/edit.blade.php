   ...
   <div>
      <div class="w-full flex items-center justify-between gap-4 border-b border-black/15 pb-3">
         <div class="flex flex-col">
            <h1 class="text-4xl font-bold leading-tight tracking-tight">Edit Service</h1>
            <p class="text-md font-normal leading-tight tracking-tight">Edit a service.</p>
         </div>
      </div>
      <form action={{ route('admin.container.services.update', $service->id) }} method="post" enctype="multipart/form-data" class="w-full flex flex-col gap-5 py-8">
         ...
         <div class="flex flex-col gap-1.5">
            ...
            <div class="relative w-full">
               ...
               <label for="image"
                  class="block w-full px-3 py-1.5 text-md bg-white dark:bg-black font-normal rounded-lg border border-black/10 dark:border-gray-700 shadow-[0_0_1px_rgba(0,0,0,0.2)] cursor-pointer">Choose
                  Image</label>
            </div>
