   ...
   <div class="w-full flex items-start justify-between gap-10 py-10">
      ...
      <div class="flex flex-col gap-4">
         ...
         <div class="flex flex-col gap-4">
            ...
            <a href={{route('about')}} class="text-white text-lg font-normal leading-tight tracking-tight">About</a>
            <a href={{route('services')}}
               class="text-white text-lg font-normal leading-tight tracking-tight">Services</a>
            <a href={{route('contact')}} class="text-white text-lg font-normal leading-tight tracking-tight">Contact
            </a>
         </div>
      </div>
      <div class="flex flex-col gap-4">
