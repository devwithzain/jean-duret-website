            ...
            <div class="flex flex-col gap-7">
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <a href={{ route('client.dashboard.container.my-loan.my_loan') }} class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                class="lucide lucide-dock-icon lucide-dock stroke-black dark:stroke-white">
                                <path d="M2 8h20" />
                ...
                <div class="relative">
                    ...
                    <div id="settingDropdown"
                        ...
                        <form action={{ route('logout') }} method="post"
                            ...
                            <div class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                    fill="none" class="dark:text-white" stroke="currentColor" stroke-width="2"
