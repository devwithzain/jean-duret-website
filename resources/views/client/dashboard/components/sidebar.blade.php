      ...
      <div class="flex flex-col gap-7">
        <div class="flex gap-2 items-center">
          ...
          <div class="flex flex-col">
            <h1 class="text-lg font-semibold text-gray-800 tracking-tight leading-tight capitalize">
              {{ auth()->user()->name }}
            </h1>
            <p class="text-sm text-gray-500 font-normal tracking-tight leading-tight">User Dashboard</p>
          </div>
        </div>
        <div class="flex flex-col gap-5">
          ...
          <div class="flex flex-col gap-4">
            ...
            <a href={{ route('client.dashboard.container.inquries.listings') }} class="flex items-center gap-2">
              ...
              <h1 class="text-md font-normal text-black tracking-tight leading-tight">Inquries</h1>
            </a>
          </div>
        </div>
      </div>
      <div class="flex gap-2 items-center justify-between">
        <div class="flex gap-2 items-center">
          ...
          <div class="flex flex-col">
            ...
            <p class="text-[12px] text-gray-500 font-normal tracking-tight leading-tight">{{ auth()->user()->email }}</p>
          </div>
        </div>
        <div class="relative">
          ...
          <div id="settingDropdown"
            ...
            <button class="w-full px-4 py-2 text-left hover:bg-gray-100 border-b border-black/20">
              <div class="flex gap-2 items-center">
                ...
                <div class="flex flex-col gap-1">
                  <h1 class="text-lg font-semibold text-gray-800 tracking-tight leading-tight">
                    {{ auth()->user()->name }}
                  </h1>
                  <p class="text-[12px] text-gray-500 font-normal tracking-tight leading-tight">
                    {{ auth()->user()->email }}
                  </p>
                </div>
              </div>
            ...
            <a href={{route('client.dashboard.container.setting.index')}}
              class="w-full block px-4 py-2 text-left hover:bg-gray-100 border-b border-black/20">
