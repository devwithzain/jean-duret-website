  ...
  <nav class="w-[14%] h-screen fixed top-0 left-0 z-50 bg-[#FAFAFA] border-r border-gray-200">
    ...
    <div class="flex flex-col gap-7">
      ...
      <div class="flex flex-col">
        <h1 class="text-xl font-semibold text-gray-800 tracking-tight leading-tight capitalize">
        {{ auth()->user()->name }}
        </h1>
    ...
    <div class="flex gap-2 items-center justify-between">
      ...
      <div id="settingDropdown"
        ...
        <div class="flex gap-2 items-center">
          ...
          alt="Preview" class="w-10 rounded-full object-cover">
          <div class="flex flex-col">
          <h1 class="text-xl font-semibold text-gray-800 tracking-tight leading-tight">
            {{ auth()->user()->name }}
          </h1>
          <p class="text-sm text-gray-500 font-normal tracking-tight leading-tight">
            {{ auth()->user()->email }}
          </p>
          </div>
        </div>
