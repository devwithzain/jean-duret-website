            ...
            <div class="flex flex-col gap-7">
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <a href={{ route('client.dashboard.container.inquries.listings') }}
                            class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="relative">
                    ...
                    <div id="settingDropdown"
                        ...
                        <button
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                <div class="flex flex-col gap-1">
                                    <h1
                                        class="text-lg font-semibold text-gray-800 dark:text-white tracking-tight leading-tight">
                                        {{ auth()->user()->name }}
                                    </h1>
                                    <p
                        ...
                        <form action={{ route('logout') }} method="post"
                            ...
                            <div class="flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                    viewBox="0 0 24 24" fill="none" class="dark:text-white" stroke="currentColor"
